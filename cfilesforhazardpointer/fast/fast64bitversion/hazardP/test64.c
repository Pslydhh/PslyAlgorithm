...
#define LISTNUM	512
DEFINE_RESOURCE_FOR_HAZARD(Record, 10, 16, 4, LISTNUM) 
...
/*    printf("NEXTB: %ld\n", NEXTB); 
    ...
    printf("IDXBIT: %ld\n", PSLY_Record_IDXBIT); 
    printf("ARRNUM: %ld\n", PSLY_Record_ARRNUM); 
    printf("ARRAYNUM: %ld\n", PSLY_Record_ARRAYNUM); 
    printf("ARRAYBITS: %ld\n", PSLY_Record_ARRAYBITS); 
	printf("ARRBIT: %ld\n", PSLY_Record_ARRBIT); 
    printf("ARRBITR: %ld\n", PSLY_Record_ARRBITR); 
    printf("ARRIDXBIT: %ld\n", PSLY_Record_ARRIDXBIT); 
    printf("NEXTIDXNUM: %ld\n", PSLY_Record_NEXTIDXNUM); 
    printf("NEXTIDXBIT: %ld\n", PSLY_Record_NEXTIDXBIT); 
	
	printf("NEXTTAILNUM: %ld\n", PSLY_Record_NEXTTAILNUM); 
	printf("NEXTTAILBIT: %ld\n", PSLY_Record_NEXTTAILBIT); 
    printf("NEXTVERSIONNUM: %ld\n", PSLY_Record_NEXTVERSIONNUM); 
    printf("NEXTVERSIONBIT: %ld\n", PSLY_Record_NEXTVERSIONBIT); 
    printf("NEXTVERSIONONE: %ld\n", PSLY_Record_NEXTVERSIONONE); 
    printf("TAILIDXNUM: %ld\n", PSLY_Record_TAILIDXNUM); 
	printf("TAILIDXBIT: %ld\n", PSLY_Record_TAILIDXBIT); 
	
    printf("TAILVERSIONNUM: %ld\n", PSLY_Record_TAILVERSIONNUM); 
    printf("TAILVERSIONBIT: %ld\n", PSLY_Record_TAILVERSIONBIT); 
	printf("TAILVERSIONONE: %ld\n", PSLY_Record_TAILVERSIONONE); 
    printf("HEADIDXNUM: %ld\n", PSLY_Record_HEADIDXNUM); 
	printf("HEADIDXBIT: %ld\n", PSLY_Record_HEADIDXBIT); 
    printf("HEADVERSIONNUM: %ld\n", PSLY_Record_HEADVERSIONNUM); 
    printf("HEADVERSIONBIT: %ld\n", PSLY_Record_HEADVERSIONBIT); 
